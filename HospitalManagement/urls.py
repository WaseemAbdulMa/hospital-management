...
urlpatterns = [
    ...
    path('admin-approve-doctor/',views.admin_approve_doctor_view,name='aadmin-approve-doctor'),
    ...
    path('admin-approve-patient/',views.admin_approve_patient_view,name='admin-aprove-patient'),
